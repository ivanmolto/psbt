...
const tabs = [
  { name: 'bip-0174.mediawiki', isActive: true },
  { name: 'bip-0370.mediawiki', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                A way for several parties to sign a Bitcoin transaction without
                any party having complete control over the transaction
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki?plain=1">
                  View on GitHub
                </Button>
              </div>
            </div>
